...
// resolveCredentials uses the AWS SDK's default credential chain (ec2 build).
// Standard precedence: env vars -> web identity (IRSA) -> container (ECS/Pod Identity)
// -> EC2 IMDS -> SSO / shared config.
